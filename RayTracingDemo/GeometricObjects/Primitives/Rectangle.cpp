...
Rectangle::sample(void) {
	// in this version, the rectangle must be square to ensure
	// the samples be uniformly distributed on its surface.
	// otherwise the distribution will be stretched in the largest direction
